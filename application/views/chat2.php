                ...
                <a class="expert" href="#">
                    ...
                    <div class="chart-infor">
                        ...
                        <div class="expert-job text-[#5C5C5C] text-base">
                            <p class="text-clip overflow-hidden ...">Web Developer Web Developer Web Developer
                                WebDeveloper Web Developer Web Developer Web Developer Web Developer</p>
                        </div>
                    </div>
                    <div class="time">
        ...
        <div class="right">
            <div class="top border-b-2">
                ...
                <div class="expert-name text-[#BF6741] text-2xl font-bold pb-3 pl-2 pt-3">
                    John Doe
                    <div class="expert-job text-[#5C5C5C] text-base pt-2">
                        <p>WebDeveloper</p>
                    </div>
                </div>
            </div>
                ...
                <div class="nest-bottom w-full">
                    ...
                    <div class="middle">
                        <div class="message-input w-full">
                            <input type="text" class="w-full h-12 rounded-full pl-4 pr-4"
...
.container .right .middle .message {
...
.container .right .middle .message p {
    word-spacing: 0.2em;
}

.container .right .middle .expert-message {
    display: flex;
    flex-direction: row;
    align-items: center;
    justify-content: flex-start;
...
.container .right .middle .expert-message .time {
    align-self: flex-end;
    margin-left: 0.5em;
    color: rgba(0, 0, 0, 0.6);
}

.container .right .middle .user-message {
    align-self: flex-end;
    display: flex;
    flex-direction: row;
    justify-content: flex-start;
...
.container .right .middle .user-message .time {
    align-self: flex-end;
    color: rgba(0, 0, 0, 0.6);
}
...
.container .right .bottom .nest-bottom {
    display: flex;
    flex-direction: row;
    align-items: center;
...
.container .right .bottom .nest-bottom .left {
    flex: 1;
    display: flex;
    flex-direction: row;
    align-items: center;
...
.container .right .bottom .nest-bottom .middle {
    width: 100%;
    flex: 8;
}

.container .right .bottom .nest-bottom .middle input:focus {
    outline: none;
}

.container .right .bottom .nest-bottom .right {
    flex: 1;
}
